      ...
      <div className="w-full max-w-md text-center space-y-5">
        ...
        <div>
          ...
          <p className="text-gray-500 text-sm">
            Your account ({" "}
            <span className="font-medium text-gray-700 dark:text-gray-300">{profile?.email}</span>) is registered, but your school admin hasn't added you to the teacher list yet.
          </p>
...
function ProtectedRoute() {
  ...
  const { currentTeacher, loading: dataLoading } = useSchoolData();
